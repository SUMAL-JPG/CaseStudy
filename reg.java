...
String proofType;
String proofID;
public reg(String name, String address, String contactNumber, String email, String proofType, String proofID)
{
this.name=name;
...
reg obj=new reg(name,address,contactNumber,email,proofType,proofID);
